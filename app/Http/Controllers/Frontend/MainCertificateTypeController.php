...
class MainCertificateTypeController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.mainCertificateTypes.index', compact('mainCertificateTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.mainCertificateTypes.create');
    }
    ...
    public function store(StoreMainCertificateTypeRequest $request)
    {
        ...
        return redirect()->route('frontend.main-certificate-types.index');
    }
    ...
    public function edit(MainCertificateType $mainCertificateType)
    {
        ...
        return view('frontend.mainCertificateTypes.edit', compact('mainCertificateType'));
    }
    ...
    public function show(MainCertificateType $mainCertificateType)
    {
        ...
        return view('frontend.mainCertificateTypes.show', compact('mainCertificateType'));
    }
