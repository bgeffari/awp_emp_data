...
class AwpEmpDataController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.awpEmpDatas.index', compact('awpEmpDatas'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.awpEmpDatas.create', compact('main_certificate_types', 'sub_certificate_types', 'majors', 'academic_facilities'));
    }
    ...
    public function edit(AwpEmpData $awpEmpData)
    {
        ...
        return view('frontend.awpEmpDatas.edit', compact('main_certificate_types', 'sub_certificate_types', 'majors', 'academic_facilities', 'awpEmpData'));
    }
    ...
    public function show(AwpEmpData $awpEmpData)
    {
        ...
        return view('frontend.awpEmpDatas.show', compact('awpEmpData'));
    }
