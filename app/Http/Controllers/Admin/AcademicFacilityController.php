...
class AcademicFacilityController extends Controller
{
    public function index()
    {
        ...
        return view('admin.academicFacilities.index', compact('academicFacilities'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.academicFacilities.create', compact('main_certificate_types'));
    }
    ...
    public function store(StoreAcademicFacilityRequest $request)
    {
        ...
        return redirect()->route('admin.academic-facilities.index');
    }
    ...
    public function edit(AcademicFacility $academicFacility)
    {
        ...
        return view('admin.academicFacilities.edit', compact('main_certificate_types', 'academicFacility'));
    }
    ...
    public function show(AcademicFacility $academicFacility)
    {
        ...
        return view('admin.academicFacilities.show', compact('academicFacility'));
    }
