    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.academic-facilities.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="academic_facility">{{ trans('cruds.academicFacility.fields.academic_facility') }}</label>
                            <input class="form-control" type="text" name="academic_facility" id="academic_facility" value="{{ old('academic_facility', '') }}" required>
