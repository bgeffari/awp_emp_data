    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sub-certificate-types.update", [$subCertificateType->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="sub_certificate_type">{{ trans('cruds.subCertificateType.fields.sub_certificate_type') }}</label>
                            <input class="form-control" type="text" name="sub_certificate_type" id="sub_certificate_type" value="{{ old('sub_certificate_type', $subCertificateType->sub_certificate_type) }}" required>
