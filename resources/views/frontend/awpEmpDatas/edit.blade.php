    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.awp-emp-datas.update", [$awpEmpData->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="emp_sap_number">{{ trans('cruds.awpEmpData.fields.emp_sap_number') }}</label>
                            <input class="form-control" type="number" name="emp_sap_number" id="emp_sap_number" value="{{ old('emp_sap_number', $awpEmpData->emp_sap_number) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\AwpEmpData::LAST_CERTIFICATE_COUNTRY_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="last_certificate_country_{{ $key }}" name="last_certificate_country" value="{{ $key }}" {{ old('last_certificate_country', $awpEmpData->last_certificate_country) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mobile" id="mobile" value="{{ old('mobile', $awpEmpData->mobile) }}" step="1" required>
