    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.majors.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="major">{{ trans('cruds.major.fields.major') }}</label>
                            <input class="form-control" type="text" name="major" id="major" value="{{ old('major', '') }}" required>
                            @if($errors->has('major'))
