    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.awp-emp-datas.update", [$awpEmpData->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nid') ? 'is-invalid' : '' }}" type="number" name="nid" id="nid" value="{{ old('nid', $awpEmpData->nid) }}" step="1" required>
                @if($errors->has('nid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nid') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('extra') ? 'is-invalid' : '' }}" name="extra" id="extra">{{ old('extra', $awpEmpData->extra) }}</textarea>
                @if($errors->has('extra'))
                    <div class="invalid-feedback">
                        {{ $errors->first('extra') }}
                    </div>
